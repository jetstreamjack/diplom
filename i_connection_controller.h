...
/**
 * @brief provides the necessary functions for processing messages for connection
 */
...
public:
     ...
     * @details each connection must be registered in order to use other interface functions
     * @return ClientHandle - client handle - it is a necessary token for using various interface functions
     */
